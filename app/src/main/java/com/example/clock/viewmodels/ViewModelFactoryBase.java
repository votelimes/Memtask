...
public class ViewModelFactoryBase extends ViewModelProvider.NewInstanceFactory {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        if (modelClass == ManageTaskViewModel.class) {
            return (T) new ManageTaskViewModel(mApplication, (Database) mParams[0], (SilentDatabase) mParams[1], (String) mParams[2], (String) mParams[3], (long) mParams[4], (String) mParams[5]);
        }
