...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        String authority = context.getString(R.string.google_maps_key);
    ...
    public static void syncImmediately(Context context) {
        ...
        ContentResolver.requestSync(getSyncAccount(context),
                context.getString(R.string.google_maps_key), bundle);
    }
    ...
    public static Account getSyncAccount(Context context) {
        ...
        Account newAccount = new Account(
                context.getString(R.string.app_name), context.getString(R.string.google_maps_key));
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        ContentResolver.setSyncAutomatically(newAccount, context.getString(R.string.google_maps_key), true);
